# Generated by Django 3.1.3 on 2021-04-22 13:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favicon', models.ImageField(blank=True, help_text='Допустимі розширення зображень png, gif, jpg, jpeg, ico', null=True, upload_to='favicon', verbose_name='Фавікон сайту')),
                ('og_image_square', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image квадрат')),
                ('og_image_square_uk', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image квадрат')),
                ('og_image_square_ru', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image квадрат')),
                ('og_image_square_en', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image квадрат')),
                ('og_image_rectangle', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image прямокутник')),
                ('og_image_rectangle_uk', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image прямокутник')),
                ('og_image_rectangle_ru', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image прямокутник')),
                ('og_image_rectangle_en', models.ImageField(blank=True, null=True, upload_to='ogimage', verbose_name='og:image прямокутник')),
                ('host', models.CharField(blank=True, help_text='Сервер', max_length=256, null=True, verbose_name='EMAIL_HOST')),
                ('port', models.SmallIntegerField(blank=True, help_text='Порт', null=True, verbose_name='EMAIL_PORT')),
                ('from_email', models.CharField(blank=True, help_text='Почта відправки листів', max_length=256, null=True, verbose_name='DEFAULT_FROM_EMAIL')),
                ('username', models.CharField(blank=True, help_text='Логін', max_length=256, null=True, verbose_name='EMAIL_HOST_USER')),
                ('password', models.CharField(blank=True, help_text='Пароль', max_length=256, null=True, verbose_name='EMAIL_HOST_PASSWORD')),
                ('use_tls', models.BooleanField(help_text=' ', verbose_name='EMAIL_USE_TLS')),
                ('use_ssl', models.BooleanField(help_text=' ', verbose_name='EMAIL_USE_SSL')),
                ('fail_silently', models.BooleanField(help_text='Помилка при невдалій відправці')),
